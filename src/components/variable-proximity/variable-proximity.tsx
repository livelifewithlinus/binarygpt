...
import './variable-proximity.scss';

type TFalloff = 'linear' | 'exponential' | 'gaussian';

type TVariableProximityProps = HTMLAttributes<HTMLSpanElement> & {
    label: string;
...
const VariableProximity = forwardRef<HTMLSpanElement, TVariableProximityProps>((props, ref) => {
    const {
        label,
